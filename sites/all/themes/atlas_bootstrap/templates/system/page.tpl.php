...
<header id="header" role="banner" class="container main-container">
  ...
  <?php endif; ?>
    ...
    <a class="name navbar-brand" href="<?php print $front_page; ?>" title="<?php print t($site_slogan, array(), array('context' => 'domain')); ?>"><?php print check_markup(t($site_slogan, array(), array('context' => 'domain'))); ?></a>
  </div>

  <div class="col col-md-4 col-md-offset-2 right-column col-sm-3 col-xs-12">
