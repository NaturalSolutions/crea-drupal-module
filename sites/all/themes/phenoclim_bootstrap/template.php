...
function phenoclim_bootstrap_preprocess_html(&$variables) {
  global $language;
  ...
  if($language->language == "en"){
    ...
    drupal_add_css(drupal_get_path('theme', 'phenoclim_bootstrap') . '/css/twentytwenty/en.css');
  }
...
function phenoclim_bootstrap_menu_tree__menu_phenoclim_main_menu($variables) {
  return '<ul class="nav navbar-nav">' . $variables['tree'] . '</ul>';
}

function phenoclim_bootstrap_menu_link(array $variables) {
...
function phenoclim_bootstrap_breadcrumb($variables) {
  $crumbs = '';
...
function phenoclim_bootstrap_preprocess_field(&$variables) {
...
function phenoclim_bootstrap_status_messages($variables) {
